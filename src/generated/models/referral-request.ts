...
export interface ReferralRequest {
    'referralType'?: ReferralRequestReferralTypeEnum;
    'referredToDepartmentId': number;
    'referredToPhysicianId'?: number;
    'referralReason'?: string;
    'clinicalSummary'?: string;
}

export const ReferralRequestReferralTypeEnum = {
    Internal: 'INTERNAL',
    External: 'EXTERNAL'
} as const;

export type ReferralRequestReferralTypeEnum = typeof ReferralRequestReferralTypeEnum[keyof typeof ReferralRequestReferralTypeEnum];
